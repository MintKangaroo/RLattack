...
models, a deterministic Scenario Generator and Gymnasium environment, unit tests, and a CI
quality gate. It contains no agent, subprocess, or network-capable code.
